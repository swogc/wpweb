...
class RWMB_Datetime_Field extends RWMB_Text_Field
{
	...
	{
		$url = evont_RWMB_CSS_URL . 'jqueryui';
		wp_register_style( 'jquery-ui-core', "$url/jquery.ui.core.css", array(), '1.8.17' );
		wp_register_style( 'jquery-ui-theme', "$url/jquery.ui.theme.css", array(), '1.8.17' );
		wp_register_style( 'wp-datepicker', evont_RWMB_CSS_URL . 'datepicker.css', array( 'jquery-ui-core', 'jquery-ui-theme' ), '1.8.17' );
		...
		$url = evont_RWMB_JS_URL . 'jqueryui';
		...
		wp_register_script( 'rwmb-datetime', evont_RWMB_JS_URL . 'datetime.js', array( 'jquery-ui-datepicker-i18n', 'jquery-ui-timepicker-i18n' ), evont_RWMB_VER, true );
		wp_register_script( 'rwmb-date', evont_RWMB_JS_URL . 'date.js', array( 'jquery-ui-datepicker-i18n', 'jquery-ui-timepicker-i18n' ), evont_RWMB_VER, true );
		wp_register_script( 'rwmb-time', evont_RWMB_JS_URL . 'time.js', array( 'jquery-ui-timepicker-i18n' ), evont_RWMB_VER, true );
