...
class RWMB_Slider_Field extends RWMB_Field
{
	...
	static function admin_enqueue_scripts()
	{
		...
		wp_enqueue_style( 'rwmb-slider', evont_RWMB_CSS_URL . 'slider.css' );

		wp_enqueue_script( 'rwmb-slider', evont_RWMB_JS_URL . 'slider.js', array( 'jquery-ui-slider', 'jquery-ui-widget', 'jquery-ui-mouse', 'jquery-ui-core' ), evont_RWMB_VER, true );
	}
