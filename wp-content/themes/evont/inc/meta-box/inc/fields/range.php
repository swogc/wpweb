...
class RWMB_Range_Field extends RWMB_Number_Field
{
	...
	{
		wp_enqueue_style( 'rwmb-range', evont_RWMB_CSS_URL . 'range.css', array(), evont_RWMB_VER );
		wp_enqueue_script( 'rwmb-range', evont_RWMB_JS_URL . 'range.js', array(), evont_RWMB_VER, true );
	}
