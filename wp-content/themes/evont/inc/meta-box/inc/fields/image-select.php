...
class RWMB_Image_Select_Field extends RWMB_Field
{
	...
	{
		wp_enqueue_style( 'rwmb-image-select', evont_RWMB_CSS_URL . 'image-select.css', array(), evont_RWMB_VER );
		wp_enqueue_script( 'rwmb-image-select', evont_RWMB_JS_URL . 'image-select.js', array( 'jquery' ), evont_RWMB_VER, true );
	}
