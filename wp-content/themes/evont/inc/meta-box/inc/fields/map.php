...
class RWMB_Map_Field extends RWMB_Field
{
	...
	static function admin_enqueue_scripts()
	{
		...
		wp_enqueue_style( 'rwmb-map', evont_RWMB_CSS_URL . 'map.css' );
		wp_enqueue_script( 'rwmb-map', evont_RWMB_JS_URL . 'map.js', array( 'jquery-ui-autocomplete', 'google-maps' ), evont_RWMB_VER, true );
	}
	...
	static function the_value( $field, $args = array(), $post_id = null )
	{
		...
		wp_register_script( 'google-maps', esc_url_raw( $google_maps_url ), array(), '', true );
		wp_enqueue_script( 'rwmb-map-frontend', evont_RWMB_JS_URL . 'map-frontend.js', array( 'google-maps' ), '', true );
