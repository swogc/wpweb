...
class RWMB_Wysiwyg_Field extends RWMB_Field
{
	...
	{
		wp_enqueue_style( 'rwmb-wysiwyg', evont_RWMB_CSS_URL . 'wysiwyg.css', array(), evont_RWMB_VER );
		wp_enqueue_script( 'rwmb-wysiwyg', evont_RWMB_JS_URL . 'wysiwyg.js', array( 'jquery' ), evont_RWMB_VER, true );
	}
