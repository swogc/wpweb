...
class RWMB_OEmbed_Field extends RWMB_Text_Field
{
	...
	{
		wp_enqueue_style( 'rwmb-oembed', evont_RWMB_CSS_URL . 'oembed.css' );
		wp_enqueue_script( 'rwmb-oembed', evont_RWMB_JS_URL . 'oembed.js', array(), evont_RWMB_VER, true );
	}
	...
	public static function get_embed( $url )
	{
		...
		return $embed ? $embed : esc_html__( 'Embed HTML not available.', 'evont' );
	}
