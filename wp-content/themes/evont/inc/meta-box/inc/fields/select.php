...
class RWMB_Select_Field extends RWMB_Choice_Field
{
	...
	{
		wp_enqueue_style( 'rwmb-select', evont_RWMB_CSS_URL . 'select.css', array(), evont_RWMB_VER );
		wp_enqueue_script( 'rwmb-select', evont_RWMB_JS_URL . 'select.js', array(), evont_RWMB_VER, true );
	}
	...
	public static function get_select_all_html( $field )
	{
		...
		{
			return '<div class="rwmb-select-all-none">' . esc_html__( 'Select', 'evont' ) . ': <a data-type="all" href="#">' . esc_html__( 'All', 'evont' ) . '</a> | <a data-type="none" href="#">' . esc_html__( 'None', 'evont' ) . '</a></div>';
		}
		return '';
	}
}
