...
class RWMB_Input_List_Field extends RWMB_Choice_Field
{
	...
	{
		wp_enqueue_style( 'rwmb-input-list', evont_RWMB_CSS_URL . 'input-list.css', array(), evont_RWMB_VER );
		wp_enqueue_script( 'rwmb-input-list', evont_RWMB_JS_URL . 'input-list.js', array(), evont_RWMB_VER, true );
	}
