...
class RWMB_Autocomplete_Field extends RWMB_Multiple_Values_Field
{
	...
	{
		wp_enqueue_style( 'rwmb-autocomplete', evont_RWMB_CSS_URL . 'autocomplete.css', array( 'wp-admin' ), evont_RWMB_VER );
		wp_enqueue_script( 'rwmb-autocomplete', evont_RWMB_JS_URL . 'autocomplete.js', array( 'jquery-ui-autocomplete' ), evont_RWMB_VER, true );
		...
		{
			wp_localize_script( 'rwmb-autocomplete', 'RWMB_Autocomplete', array( 'delete' => esc_html__( 'Delete', 'evont' ) ) );
		}
	}
