...
class RWMB_Color_Field extends RWMB_Text_Field
{
	...
	{
		wp_enqueue_style( 'rwmb-color', evont_RWMB_CSS_URL . 'color.css', array( 'wp-color-picker' ), evont_RWMB_VER );
		wp_enqueue_script( 'rwmb-color', evont_RWMB_JS_URL . 'color.js', array( 'wp-color-picker' ), evont_RWMB_VER, true );
	}
