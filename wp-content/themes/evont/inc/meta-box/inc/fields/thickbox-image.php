...
class RWMB_Thickbox_Image_Field extends RWMB_Image_Field
{
	...
	public static function admin_enqueue_scripts()
	{
		...
		wp_enqueue_script( 'rwmb-thickbox-image', evont_RWMB_JS_URL . 'thickbox-image.js', array( 'jquery' ), evont_RWMB_VER, true );
	}
	...
	{
		$i18n_title = apply_filters( 'rwmb_thickbox_image_upload_string', _x( 'Upload Images', 'image upload', 'evont' ), $field );
