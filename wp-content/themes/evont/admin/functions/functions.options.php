	...
	function of_options()
	{
		...
		//////// General Options//////////////
				...
				$of_options[] = array( "name" => "Import Demo Content",
					...
					"type" => "button",
					"desc" => 'You can import evont Wordpress Theme demo by One-click demo importer. By Importing our demo you can start build your website easily exactly similar to the one exist on this link http://evont.janxcode.com',
					);				
		...
		$of_options[] = array( "name" => "Select Header Layout",
			"desc" => "Choose header layout.",
			"id" => "select_header",
			"std" => "header-1",
			"type" => "images",
			"options" => array(
				"header-1" => get_template_directory_uri()."/images/header/header-1.jpg",
				"header-2" => get_template_directory_uri()."/images/header/header-2.jpg",
				)
		); //Done Change
		...
		$of_options[] = array( "name" => "Titlebar",
					"desc" => "Set default titlebar.",
					"id" => "select_header_titlebar",
					"std" => "Default",
					"type" => "select",
					"options" => array(
						'default' => 'Default',
		...
		$of_options[] = array( "name" => "Event Title",
							"desc" => "Event Ttitle",
							"id" => "info_event_title",
							"std" => "World Business Conference",
							"type" => "text"); //Done Change
							
							
		$of_options[] = array( "name" => "Ticket Link",
							"desc" => "Event Ttitle",
							"id" => "info_event_ticket_link",
							"std" => "#",
							"type" => "text"); //Done Change													
		...
		$of_options[] = array( "name" => "Footer Logo",
							...
							"id" => "evont_footer_logo",
							"std" => get_template_directory_uri()."/images/logo.png",
							"mod" => "",
							"type" => "media");
							
		$of_options[] = array( "name" => "Footer Logo (Retina Version @2x)",
							"desc" => "Select an image file for the retina version of the logo. It should be exactly 2x the size of main logo.",
		...
		$of_options[] = array( "name" => "Copyright",
					...
					"id" => "text_copyright",
					"std" => "Copyrights &copy; 2016 - Design by",
					"type" => "text"); //Done Change
		...
		$of_options[] = array( "name" => "Typography",
							...
							$of_options[] = array( "name" => "Excpetional Font used in code",
		...
		$of_options[] = array( "name" => "Enable Sharebox",
							"desc" => "Check to enable Sharebox.",
		...
		$of_options[] = array( "name" => "Show in Header",
							"desc" => "Show social network in header.",
		...
		//Sharebox
$of_options[] = array( "name" => "Sharebox Options",
						"type" => "heading"
						//"icon"	=> ADMIN_IMAGES . "icon-slider.png"
						);
$of_options[] = array( "name" => "Enable Sharebox Network",
					"desc" => "",
					"id" => "header_info",
					"std" => "<h3 style='margin: 0'>Enable Sharebox Network</h3>",
					"icon" => false,
					"type" => "info");
$of_options[] = array( "name" => "Twitter",
						"desc" => "Enable sharing to twitter",
						"id" => "sharebox_twitter",
						"std" => "1",
						"type" => "checkbox"); //Done Change	
$of_options[] = array( "name" => "Facebook",
						"desc" => "Enable sharing to facebook",
						"id" => "sharebox_facebook",
						"std" => "1",
						"type" => "checkbox"); //Done Change
$of_options[] = array( "name" => "Google +",
						"desc" => "Enable sharing to google+",
						"id" => "sharebox_googleplus",
						"std" => "1",
						"type" => "checkbox"); //Done Change	
						
$of_options[] = array( "name" => "Linkedin",
						"desc" => "Enable sharing to linkedin",
						"id" => "sharebox_linkedin",
						"std" => "1",
						"type" => "checkbox"); //Done Change						
						
$of_options[] = array( "name" => "Delicious",
						"desc" => "Enable sharing to delicious",
						"id" => "sharebox_delicious",
						"std" => "1",
						"type" => "checkbox"); //Done Change	
$of_options[] = array( "name" => "Digg",
						"desc" => "Enable sharing to digg",
						"id" => "sharebox_digg",
						"std" => "1",
						"type" => "checkbox"); //Done Change	
$of_options[] = array( "name" => "Reddit",
						"desc" => "Enable sharing to reddit",
						"id" => "sharebox_reddit",
						"std" => "1",
						"type" => "checkbox"); //Done Change	
$of_options[] = array( "name" => "Email",
						"desc" => "Enable sharing link by email",
						"id" => "sharebox_email",
						"std" => "1",
						"type" => "checkbox"); //Done Change	
